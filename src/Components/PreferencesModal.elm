          ...
          Just { closeMessage = Just HideDialog
               ...
               , body = Just ( div [Styles.modal] [
                        ...
                        Form.group [] [
                          ...
                          Input.text [Input.id "keywords",Input.value model.preferences.keywords, Input.attrs [placeholder "Enter your keywords separated with a space",
                          onInput UpdatePreferencesKeywords]]
                        ],
                        Form.group [] [
                          Form.label [for "genre"] [text "Genre: "],
                          Input.text [Input.id "genre",Input.value model.preferences.genre, Input.attrs [placeholder "Enter your favorite genre",
                          onInput UpdatePreferencesGenre]]
                        ],
                        Form.group [] [
                          Form.label [for "actor"] [text "Actor: "],
                          Input.text [Input.id "actor", Input.value model.preferences.favoriteActor,Input.attrs [placeholder "Enter your favorite actor",onInput UpdatePreferencesActor]]
                        ],
